...
import { approveMember, rejectMember } from "../../api/adminApi";

export default function UserCard({ member, onApproval }) {
  ...
  const handleReject = async () => {
    console.log("거부");
    const response = await rejectMember(member.userId);
    console.log(response);
    onApproval();
  };

  return (
    <article key={member.id} className={styles.approvalCard}>
